...
;// CONCATENATED MODULE: ./node_modules/readdirp/esm/index.js
...
class ReaddirpStream extends external_node_stream_.Readable {
    constructor(options = {}) {
        ...
        const statMethod = opts.lstat ? external_node_fs_promises_.lstat : external_node_fs_promises_.stat;
    ...
    async _exploreDir(path, depth) {
        let files;
        try {
            files = await (0,external_node_fs_promises_.readdir)(path, this._rdOptions);
        }
        catch (error) {
            this._onError(error);
        }
    ...
    async _getEntryType(entry) {
        ...
        if (stats && stats.isSymbolicLink()) {
            ...
            try {
                const entryRealPath = await (0,external_node_fs_promises_.realpath)(full);
                const entryRealPathStats = await (0,external_node_fs_promises_.lstat)(entryRealPath);
...
;// CONCATENATED MODULE: ./node_modules/chokidar/esm/handler.js
...
;// CONCATENATED MODULE: ./node_modules/chokidar/esm/index.js
